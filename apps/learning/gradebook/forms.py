...
from learning.models import Course, StudentAssignment
...
class EnrollmentFinalGrade(forms.TypedChoiceField):
    def __init__(self, student, course, is_readonly: bool = False):
        ...
        super().__init__(
            choices=student._enrollment.grade_choices,
            required=False,
            show_hidden_initial=True,
            widget=widget,
            coerce=int,
            empty_value=GradeTypes.NOT_GRADED,
        )
        # Used to simplify `form.save()` method
