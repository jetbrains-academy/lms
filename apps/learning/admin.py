...
from courses.admin import BaseCourseBindingInline
from courses.models import CourseGroupModes, CourseProgramBinding, CourseTeacher, Assignment, Course
from learning.models import (
    AssignmentScoreAuditLog, Invitation,
...
class EnrollmentAdmin(BaseModelAdmin):
    ...
    raw_id_fields = ("student", "course", "student_profile", "student_group")
...
class CourseInvitationInline(BaseCourseBindingInline):
    fields = ('course', 'enrollment_end_date', 'grading_system_num')


class InvitationAdmin(BaseModelAdmin):
    list_display = ('name', 'semester', 'get_link')
    list_select_related = ['semester']
    inlines = (CourseInvitationInline, )
    list_filter = [
