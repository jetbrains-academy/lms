...
class BaseStubImage(BaseImageFile):
    @property
    def url(self):
        return staticfiles_storage.url(f"v1/img/placeholder/user{self._suffix}.png")
...
class BoyStubImage(BaseStubImage):
    @property
    def url(self):
        return staticfiles_storage.url(f"v1/img/placeholder/boy{self._suffix}.png")


class BoyStubImageSVG(BaseStubImage):
    @property
    def url(self):
        return staticfiles_storage.url(f"v1/img/placeholder/boy{self._suffix}.svg")


class GirlStubImage(BaseStubImage):
    @property
    def url(self):
        return staticfiles_storage.url(f"v1/img/placeholder/girl{self._suffix}.png")


class GirlStubImageSVG(BaseStubImage):
    @property
    def url(self):
        return staticfiles_storage.url(f"v1/img/placeholder/girl{self._suffix}.svg")


class ManStubImage(BaseStubImage):
    @property
    def url(self):
        return staticfiles_storage.url(f"v1/img/placeholder/man{self._suffix}.png")


class WomanStubImage(BaseStubImage):
    @property
    def url(self):
        return staticfiles_storage.url(f"v1/img/placeholder/woman{self._suffix}.png")
