...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.CharField(choices=[('online', 'Online Submission'), ('external', 'External Service'), ('code_review', 'Code Review Submission'), ('penalty', 'Penalty'), ('other', 'No Submission')], max_length=42, verbose_name='Assignment Format'),
        ),
        migrations.AlterField(
            model_name='course',
            name='group_mode',
