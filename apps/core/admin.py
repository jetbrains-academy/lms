...
from core.models import Location, University, AcademicProgram, AcademicProgramRun, Config
...
@admin.register(AcademicProgramRun)
class AcademicProgramRunAdmin(admin.ModelAdmin):
    list_select_related = ['program']
    list_display = ('start_year', 'program')
